...
const menuItems = [
	{ id: 1, title: "+$10.00", color: "red" },
	{ id: 2, title: "-$10.00", color: "green" },
	{ id: 3, title: "+$10.00", color: "green" },
		...
		<View>
			<View style={{ alignItems: "center" }}>
				...
				<View style={styles.texty}>
					...
					<FontText style={{ fontSize: 45, fontWeight: "700" }}>
						$128.64
					</FontText>
					<View
						style={{
					...
					>
						<View style={styles.history}>
							<FontText style={styles.size}>History</FontText>
							<FontText style={styles.see}>See all</FontText>
						</View>
